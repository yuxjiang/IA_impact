...
s2min.gotcha.mfo.f2014 = s2min_from_curve(gotcha_rmcurve.mfo.c2014);

s2min.gotcha.bpo.f2011 = s2min_from_curve(gotcha_rmcurve.bpo.c2011);
s2min.gotcha.bpo.f2014 = s2min_from_curve(gotcha_rmcurve.bpo.c2014);

s2min.gotcha.cco.f2011 = s2min_from_curve(gotcha_rmcurve.cco.c2011);
s2min.gotcha.cco.f2014 = s2min_from_curve(gotcha_rmcurve.cco.c2014);
% }}}

% BLAST {{{
s2min.blast.mfo.f2011 = s2min_from_curve(blast_rmcurve.mfo.c2011);
s2min.blast.mfo.f2014 = s2min_from_curve(blast_rmcurve.mfo.c2014);

s2min.blast.bpo.f2011 = s2min_from_curve(blast_rmcurve.bpo.c2011);
s2min.blast.bpo.f2014 = s2min_from_curve(blast_rmcurve.bpo.c2014);

s2min.blast.cco.f2011 = s2min_from_curve(blast_rmcurve.cco.c2011);
s2min.blast.cco.f2014 = s2min_from_curve(blast_rmcurve.cco.c2014);
% }}}

% Swiss-Prot {{{
s2min.com.mfo.f2011 = s2min_from_curve(com_rmcurve.mfo.c2011);
s2min.com.mfo.f2014 = s2min_from_curve(com_rmcurve.mfo.c2014);

s2min.com.bpo.f2011 = s2min_from_curve(com_rmcurve.bpo.c2011);
s2min.com.bpo.f2014 = s2min_from_curve(com_rmcurve.bpo.c2014);

s2min.com.cco.f2011 = s2min_from_curve(com_rmcurve.cco.c2011);
s2min.com.cco.f2014 = s2min_from_curve(com_rmcurve.cco.c2014);
% }}}
...
% Last modified: Thu 14 Jul 2016 05:29:32 PM E
