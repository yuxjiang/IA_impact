%OUTPUT_s2min_TABLE Output S2-max table
%
...
% Last modified: Wed 02 Apr 2014 01:47:58 PM EDT
...
s2min.gotcha.bpo.f2012 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.b2012);
s2min.gotcha.bpo.f2013 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.b2013);
s2min.gotcha.bpo.f2014 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.b2014);
s2min.gotcha.bpo.g2012 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.c2012);
s2min.gotcha.bpo.g2013 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.c2013);
s2min.gotcha.bpo.g2014 = pfp_semdistmin(gotcha_rmcurve_ia.bpo.c2014);

s2min.gotcha.cco.f2011 = pfp_semdistmin(gotcha_rmcurve.cco.c2011);
s2min.gotcha.cco.f2012 = pfp_semdistmin(gotcha_rmcurve_ia.cco.b2012);
s2min.gotcha.cco.f2013 = pfp_semdistmin(gotcha_rmcurve_ia.cco.b2013);
s2min.gotcha.cco.f2014 = pfp_semdistmin(gotcha_rmcurve_ia.cco.b2014);
s2min.gotcha.cco.g2012 = pfp_semdistmin(gotcha_rmcurve_ia.cco.c2012);
s2min.gotcha.cco.g2013 = pfp_semdistmin(gotcha_rmcurve_ia.cco.c2013);
s2min.gotcha.cco.g2014 = pfp_semdistmin(gotcha_rmcurve_ia.cco.c2014);

s2min.gotcha.mfo.f2011 = pfp_semdistmin(gotcha_rmcurve.mfo.c2011);
s2min.gotcha.mfo.f2012 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.b2012);
s2min.gotcha.mfo.f2013 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.b2013);
s2min.gotcha.mfo.f2014 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.b2014);
s2min.gotcha.mfo.g2012 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.c2012);
s2min.gotcha.mfo.g2013 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.c2013);
s2min.gotcha.mfo.g2014 = pfp_semdistmin(gotcha_rmcurve_ia.mfo.c2014);
...
s2min.blast.bpo.f2012 = pfp_semdistmin(blast_rmcurve_ia.bpo.b2012);
s2min.blast.bpo.f2013 = pfp_semdistmin(blast_rmcurve_ia.bpo.b2013);
s2min.blast.bpo.f2014 = pfp_semdistmin(blast_rmcurve_ia.bpo.b2014);
s2min.blast.bpo.g2012 = pfp_semdistmin(blast_rmcurve_ia.bpo.c2012);
s2min.blast.bpo.g2013 = pfp_semdistmin(blast_rmcurve_ia.bpo.c2013);
s2min.blast.bpo.g2014 = pfp_semdistmin(blast_rmcurve_ia.bpo.c2014);

s2min.blast.cco.f2011 = pfp_semdistmin(blast_rmcurve.cco.c2011);
s2min.blast.cco.f2012 = pfp_semdistmin(blast_rmcurve_ia.cco.b2012);
s2min.blast.cco.f2013 = pfp_semdistmin(blast_rmcurve_ia.cco.b2013);
s2min.blast.cco.f2014 = pfp_semdistmin(blast_rmcurve_ia.cco.b2014);
s2min.blast.cco.g2012 = pfp_semdistmin(blast_rmcurve_ia.cco.c2012);
s2min.blast.cco.g2013 = pfp_semdistmin(blast_rmcurve_ia.cco.c2013);
s2min.blast.cco.g2014 = pfp_semdistmin(blast_rmcurve_ia.cco.c2014);

s2min.blast.mfo.f2011 = pfp_semdistmin(blast_rmcurve.mfo.c2011);
s2min.blast.mfo.f2012 = pfp_semdistmin(blast_rmcurve_ia.mfo.b2012);
s2min.blast.mfo.f2013 = pfp_semdistmin(blast_rmcurve_ia.mfo.b2013);
s2min.blast.mfo.f2014 = pfp_semdistmin(blast_rmcurve_ia.mfo.b2014);
s2min.blast.mfo.g2012 = pfp_semdistmin(blast_rmcurve_ia.mfo.c2012);
s2min.blast.mfo.g2013 = pfp_semdistmin(blast_rmcurve_ia.mfo.c2013);
s2min.blast.mfo.g2014 = pfp_semdistmin(blast_rmcurve_ia.mfo.c2014);
...
s2min.com.bpo.f2012 = pfp_semdistmin(com_rmcurve_ia.bpo.b2012);
s2min.com.bpo.f2013 = pfp_semdistmin(com_rmcurve_ia.bpo.b2013);
s2min.com.bpo.f2014 = pfp_semdistmin(com_rmcurve_ia.bpo.b2014);
s2min.com.bpo.g2012 = pfp_semdistmin(com_rmcurve_ia.bpo.c2012);
s2min.com.bpo.g2013 = pfp_semdistmin(com_rmcurve_ia.bpo.c2013);
s2min.com.bpo.g2014 = pfp_semdistmin(com_rmcurve_ia.bpo.c2014);

s2min.com.cco.f2011 = pfp_semdistmin(com_rmcurve.cco.c2011);
s2min.com.cco.f2012 = pfp_semdistmin(com_rmcurve_ia.cco.b2012);
s2min.com.cco.f2013 = pfp_semdistmin(com_rmcurve_ia.cco.b2013);
s2min.com.cco.f2014 = pfp_semdistmin(com_rmcurve_ia.cco.b2014);
s2min.com.cco.g2012 = pfp_semdistmin(com_rmcurve_ia.cco.c2012);
s2min.com.cco.g2013 = pfp_semdistmin(com_rmcurve_ia.cco.c2013);
s2min.com.cco.g2014 = pfp_semdistmin(com_rmcurve_ia.cco.c2014);

s2min.com.mfo.f2011 = pfp_semdistmin(com_rmcurve.mfo.c2011);
s2min.com.mfo.f2012 = pfp_semdistmin(com_rmcurve_ia.mfo.b2012);
s2min.com.mfo.f2013 = pfp_semdistmin(com_rmcurve_ia.mfo.b2013);
s2min.com.mfo.f2014 = pfp_semdistmin(com_rmcurve_ia.mfo.b2014);
s2min.com.mfo.g2012 = pfp_semdistmin(com_rmcurve_ia.mfo.c2012);
s2min.com.mfo.g2013 = pfp_semdistmin(com_rmcurve_ia.mfo.c2013);
s2min.com.mfo.g2014 = pfp_semdistmin(com_rmcurve_ia.mfo.c2014);
